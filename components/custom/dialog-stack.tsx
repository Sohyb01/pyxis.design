...
export const DialogStackBody = ({
  ...
  const [totalDialogs, setTotalDialogs] = useState(count);
  ...
  return (
    <DialogStackContext.Provider
      value={{ ...context, totalDialogs, setTotalDialogs }}
    >
      <Portal.Root>
        <div
          className={cn(
...
export const DialogStackContent = ({
  ...
  return (
    ...
    <div
      className={cn(
        "h-auto w-full rounded-3xl border bg-background p-6 shadow-lg transition-all duration-300",
        className,
      )}
      onClick={handleClick}
      style={{
